...
c
      ...
      NN=4
      alpha=0.261799
      rS=real(2.16578d22/udist)
      p0=real(2.12889d-24*(udist)**3./(umass))
      phir=real(6.3d-16*utime)
...
c for corona
      ...
      rc2=real(2.019d21/udist)
      p1=real(6.19d-31*(udist)**3./(umass))

c H2 formation parameters

c  Rate of formation on grains
      Rconst=0.3*2.2e-18
