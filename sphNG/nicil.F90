...
!                                                                      !
!                 Copyright (c) 2015-2022 James Wurster                !
...
module nicil
 ...
 integer, public, parameter :: na                = 17                ! Hardcoded for storage efficiency ( na >=0 )! MRB's initial grain distribution; assuming fixed
 !integer, public, parameter :: na                = 53                ! Hardcoded for storage efficiency ( na >=0 )! MRB's dust coagulation
 ...
 real,    public            :: an_grain          = 5.0d-7    ! 3.0d-6           ! minimum grain radius for distribution [cm]
 real,    public            :: ax_grain          = 2.5078d-5 ! 2.5d-5           ! maximum grain radius for grain distribution [cm]
 ...
 real,    public            :: zeta_cgs          =  1.2d-17          ! ionisation rate [s^-1]
...
subroutine nicil_print_summary(a_grain_cgs,rho_grain,meanmolmass,grain_sizes_in)
 ...
 write(iprint,'(a)' ) "NICIL: Copyright (c) 2015-2022 James Wurster"
