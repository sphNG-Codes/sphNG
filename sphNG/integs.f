...
98022       FORMAT (' step only    time: ', F8.3, ' min. ',F6.3,' %')
98008       FORMAT (' densityi     time: ', F8.3, ' min. ',F6.3,' %')
98009       FORMAT (' forcei       time: ', F8.3, ' min. ',F6.3,' %')
98016       FORMAT (' gforspt      time: ', F8.3, ' min. ',F6.3,' %')
98003       FORMAT (' insulate     time: ', F8.3, ' min. ',F6.3,' %')
98004       FORMAT ('  GRP init    time: ', F8.3, ' min. ',F6.3,' %')
98005       FORMAT ('  GRP sort    time: ', F8.3, ' min. ',F6.3,' %')
98006       FORMAT ('  GRP load    time: ', F8.3, ' min. ',F6.3,' %')
98007       FORMAT ('  GRP call1   time: ', F8.3, ' min. ',F6.3,' %')
98010       FORMAT ('  GRP gravity time: ', F8.3, ' min. ',F6.3,' %')
98011       FORMAT ('  GRP nei get time: ', F8.3, ' min. ',F6.3,' %')
98012       FORMAT ('  GRP call2   time: ', F8.3, ' min. ',F6.3,' %')
98013       FORMAT ('  GRP call3   time: ', F8.3, ' min. ',F6.3,' %')
98014       FORMAT ('  GRP nstore  time: ', F8.3, ' min. ',F6.3,' %')
98015       FORMAT ('  GRP nmisc   time: ', F8.3, ' min. ',F6.3,' %')
98017       FORMAT ('  TRE mtree   time: ', F8.3, ' min. ',F6.3,' %')
98018       FORMAT ('  TRE treef   time: ', F8.3, ' min. ',F6.3,' %')
98019       FORMAT ('  TRE revtree time: ', F8.3, ' min. ',F6.3,' %')
98119       FORMAT ('  TRE revtree1time: ', F8.3, ' min. ',F6.3,' %')
98120       FORMAT ('  TRE revtree2time: ', F8.3, ' min. ',F6.3,' %')
98021       FORMAT (' accrete      time: ', F8.3, ' min. ',F6.3,' %')
98023       FORMAT (' step-1       time: ', F8.3, ' min. ',F6.3,' %')
98024       FORMAT (' step-2       time: ', F8.3, ' min. ',F6.3,' %')
98025       FORMAT (' step-3       time: ', F8.3, ' min. ',F6.3,' %')
98026       FORMAT (' step-4       time: ', F8.3, ' min. ',F6.3,' %')
98027       FORMAT (' step-5       time: ', F8.3, ' min. ',F6.3,' %')
98028       FORMAT (' step-6       time: ', F8.3, ' min. ',F6.3,' %')
98029       FORMAT (' step-7       time: ', F8.3, ' min. ',F6.3,' %')
98030       FORMAT (' step-8       time: ', F8.3, ' min. ',F6.3,' %')
98031       FORMAT (' step-9       time: ', F8.3, ' min. ',F6.3,' %')
98032       FORMAT (' derivi-1     time: ', F8.3, ' min. ',F6.3,' %')
98033       FORMAT (' derivi-2     time: ', F8.3, ' min. ',F6.3,' %')
         ELSE
            WRITE (iprint, 98020)
            WRITE (iprint, 98022) tsteponly/60., tsteponly/tstep*100.
            WRITE (iprint, 98008) tdens/60.,   tdens/tstep*100.
