      SUBROUTINE mtreepara(nnatom, npart, xyzmh)
c************************************************************
c                                                           *
...
c      CALL getused(timex1)

cC$OMP SECTIONS
c      CALL indexx3(nactive, list, xyzmh, 1, next1)
c      DO i = 1, nactive
c         write (31,*) list(next1(i)),xyzmh(1,list(next1(i)))
c      END DO
cC$OMP SECTION
c      CALL indexx3(nactive, list, xyzmh, 2, next2)
c      DO i = 1, nactive
c         write (32,*) list(next2(i)),xyzmh(2,list(next2(i)))
c      END DO
cC$OMP SECTION
c      CALL indexx3(nactive, list, xyzmh, 3, next3)
c      DO i = 1, nactive
c         write (33,*) list(next3(i)),xyzmh(3,list(next3(i)))
c      END DO
cC$OMP END SECTIONS

c      CALL getused(timex2)

c      print *,timex2-timex1

      CALL indexx3merge(nactive, list, xyzmh, next1, next2, next3)
c      DO i = 1, nactive
c         write (41,*) list(next1(i)),xyzmh(1,list(next1(i)))
c      END DO
c      DO i = 1, nactive
c         write (42,*) list(next2(i)),xyzmh(2,list(next2(i)))
c      END DO
c      DO i = 1, nactive
c         write (43,*) list(next3(i)),xyzmh(3,list(next3(i)))
c      END DO
