...
c
      ...
      DO i=1,4601
        WRITE(8) ((log10(utable(j,i))), j=1, 1801)
      END DO
      CLOSE(8)

c      DO I=1,1801
c        write(3,*) utable(i,1),I
c                IF(MOD(I,100).EQ.0) THEN
c          WRITE(94,66) utable(i,1),utable(i,100),utable(i,500),
c     $     utable(i,1000),utable(i,2000),
c     $     utable(i,3000),utable(i,4600)
c        ENDIF
c      ENDDO
