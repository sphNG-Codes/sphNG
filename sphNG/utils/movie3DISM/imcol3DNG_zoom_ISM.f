...
c     density and density-weighted temperature, using a    *
c     perspective projection (as for the 3D movie code).   *
c                                                          *
...
c                                                          *
c     For the Bate+Keto ISM model it outputs not just      *
c     density and gas temperature files, but files for     *
c                                                          *
c        D: column density                                 *
c        T: gas temperature (density weighted)             *
c        U: dust temperature (density weighted)            *
c        R: radiation temperature (density weighted)       *
c        I: HI/H ratio (density weighted)                  *
c        M: H_2/(2H) ratio (density weighted)              *
c        P: C+/C ratio (density weighted)                  *
c        A: atomic C to C ratio (density weighted)         *
c        O: CO/C ratio (density weighted)                  *
c                                                          *
c     Compile like: make mpi=no openmp=yes movie3DISM      *
c                                                          *
c***********************************************************
...
c
         ...
         ELSE
            CALL grid (zobsdo,wangledo,16,17,xeyedo,idt,coutour1)
            CALL grid (zobsdo,wangledo,16,17,-xeyedo,idt,coutour1)
         ENDIF
