...
98022       FORMAT (' step only    time: ', F8.3, ' min. ',F5.2,' %')
...
98119       FORMAT ('  TRE revtree1time: ', F8.3, ' min. ',F5.2,' %')
98120       FORMAT ('  TRE revtree2time: ', F8.3, ' min. ',F5.2,' %')
98021       FORMAT (' accrete      time: ', F8.3, ' min. ',F5.2,' %')
98023       FORMAT (' step-1       time: ', F8.3, ' min. ',F5.2,' %')
98024       FORMAT (' step-2       time: ', F8.3, ' min. ',F5.2,' %')
98025       FORMAT (' step-3       time: ', F8.3, ' min. ',F5.2,' %')
98026       FORMAT (' step-4       time: ', F8.3, ' min. ',F5.2,' %')
98027       FORMAT (' step-5       time: ', F8.3, ' min. ',F5.2,' %')
98028       FORMAT (' step-6       time: ', F8.3, ' min. ',F5.2,' %')
98029       FORMAT (' step-7       time: ', F8.3, ' min. ',F5.2,' %')
98030       FORMAT (' step-8       time: ', F8.3, ' min. ',F5.2,' %')
98031       FORMAT (' step-9       time: ', F8.3, ' min. ',F5.2,' %')
98032       FORMAT (' derivi-1     time: ', F8.3, ' min. ',F5.2,' %')
98033       FORMAT (' derivi-2     time: ', F8.3, ' min. ',F5.2,' %')
         ELSE
            WRITE (iprint, 98020)
            WRITE (iprint, 98022) tsteponly/60., tsteponly/tstep*100.
            WRITE (iprint, 98008) tdens/60.,   tdens/tstep*100.
